<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"C:\xampp\htdocs\think5\public/../application/user\view\userhotai\zhanghao.html";i:1529913270;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                            ...
                                            <div class="am-form-group am-form-file">
                                                <div id="fileList" class="tpl-form-file-img uploader-list">
                                                    <div id="old" class="file-item thumbnail">
                                                        ...
                                                        <input type="text" style="display:none" name="logo" value="<?php echo $author['logo']; ?>">
                                                    </div>
                                                </div>
